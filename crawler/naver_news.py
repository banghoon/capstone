...
def find_last_page(url, path='chromedriver_94.exe'):
...
#     options.add_argument("disable-gpu")
#
#     driver = webdriver.Chrome('./utils.exe', chrome_options=options)
#     driver.get(url)
#     try:
...
def crawling_news(date, path='chromedriver_94.exe'):
    menu = {
